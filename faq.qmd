...
For the ladies, we want each of you to feel comfortable and elegant, so opt for flowing dresses with natural details. Consider platform heels (not stilettos). Consider platform heels (no stilettos).
